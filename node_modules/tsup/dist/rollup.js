...
var logger = _chunkPPWAWKPLjs.createLogger.call(void 0, );
...
var getRollupConfig = async (options) => {
  ...
  return {
    ...
    outputConfig: options.format.map((format) => {
      var _a3;
      const outputExtension = ((_a3 = options.outExtension) == null ? void 0 : _a3.call(options, { format, options, pkgType: pkg.type }).dts) || _chunkB7UJSB4Njs.defaultOutExtension.call(void 0, { format, pkgType: pkg.type }).dts;
      return {
